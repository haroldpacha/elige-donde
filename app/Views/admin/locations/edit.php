...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Editar Ubicación</h1>
    </div>

    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Editar Ubicación</h6>
        </div>
        <div class="card-body">
            ...
            <form action="/admin/ubicaciones/update/<?= $location['id'] ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="department" name="department" value="<?= old('department', $location['department']) ?>" required>
                </div>
