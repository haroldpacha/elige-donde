...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Editar Característica</h1>
    </div>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="/admin/caracteristicas/<?= $feature['id'] ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="category" name="category" value="<?= old('category', $feature['category']) ?>">
                </div>

                <div class="form-group">
                    <label for="icon">Icono (Font Awesome)</label>
                    <input type="text" class="form-control" id="icon" name="icon" value="<?= old('icon', $feature['icon']) ?>">
